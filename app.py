...
# ════════════════════════════════════════════════════════════════════
    ...
    st.dataframe(df[['Provider']+FEATURE_COLS[:10]].head(10), width="stretch")
    ...
    st.dataframe(sd.style.background_gradient(cmap='RdYlGn_r',subset=['Ratio Fraud/Legit']), width="stretch")
...
# ════════════════════════════════════════════════════════════════════
    ...
    st.dataframe(results.sort_values('Probability',ascending=False), width="stretch")
